...
export default function Page() {
  return (
    <>
      <div className="row">
        <h3 className="text-primary text-center">Rising Stars Project</h3>
          ...
          <table className="table table-hover table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                <td>11-JAN-2013</td>
                <td>
                  Municipal School, Korattur, Chennai
                </td>
                <td>
                  Motivated 6th to 10th standard <br />students by distributing complementary gifts
                </td>
              </tr>
            </tbody>
          </table>
